    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          ...
          <p>
          Podemos ayudarte a restablecer tu contraseña e información de seguridad. Primero, ingrese <br> su dirección de correo electrónico y haga clic en enviar enlace de restablecimiento.
          </p>
        </div>
      </div>
    </div>
